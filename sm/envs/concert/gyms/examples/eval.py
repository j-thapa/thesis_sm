...
register_env("WarehouseEnv_3",
                      lambda config: WarehouseEnv_3(config, agent_ids=agents, max_steps=70, deterministic_game=  False, obs_stacking= False,
                                ...
                                , obstacle = False, goal_area =True, dynamic= False, mode="training",
...
checkpoint_path = "D:/Profactor/ray_results/demo_goal_area/checkpoint_006406"
...
def evaluate(num_episodes = 1):
    ...
    env =  WarehouseEnv_3(env_config= env_config, agent_ids=agents, max_steps = 30, deterministic_game= False, obs_stacking= False,
...
def evaluate_to_csv(episodes=300, name="evaluation_csv", obs_stack = False):
    ...
    with open(name, 'w') as f:
        ...
        env =  WarehouseEnv_3(env_config= env_config, agent_ids=agents, max_steps=70, deterministic_game=False, obs_stacking= False,
                                    image_observation=image_observation, action_masking=action_masking, num_objects =2, obstacle = False, goal_area = True, dynamic= False, mode="evaluation",
                                    goals_coord = [(8,2),(5,2),(7,4),(2,5),(3,8)])
...
def turn_basis_evaluate_to_csv(episodes=300, name="evaluation_csv",obs_stack=True):
    ...
    with open(name, 'w') as f:
        ...
        env = WarehouseEnv_3(env_config, agent_ids=agents, max_steps=40, deterministic_game=False, obs_stacking = obs_stack,
                            image_observation=image_observation, action_masking=action_masking, num_objects=1, obstacle= False, mode="evaluation",
                            dynamic=False,  goals_coord = [(2,7),(4,2),(6,5),(7,3)])
...
# evaluate_to_csv(episodes=200, name="phase_shift_1", obs_stack=False)
