...
def train_h_agent_agent_ppo():
    ...
    tune.register_env("WarehouseEnv_3",
                      lambda config: WarehouseEnv_3(config, agent_ids=agents, max_steps=40, deterministic_game=False, obs_stacking= False,
    ...
    configuration = {
        ...
        "env_config": {
            ...
            "dynamic_obstacle_randomness": 0.0, #tune.grid_search([0.00, 0.20, 0.40, 0.60, 0.80, 1]), #defualt 0.25
            "heuristic_agent_randomness": 0.0, #tune.grid_search([0.00, 0.20, 0.40, 0.60, 0.80, 1]) #defualt 0.25
            "seed":  2
            },
        "log_level": "WARN",
        "num_gpus": 0.25, ### gpu share assigned to local trainer
        "num_workers": 3,
        ...
        "entropy_coeff": 0.0079,  #tune.uniform(lower,upper) triggers hyperparameter search (a simple random search)
        # "lr": 0.00005,
        # "lr": tune.grid_search([0.0001, 0.00005]),
        "use_gae": True,
    ...
    results = tune.run(
        ...
        name = "drop_penalty_goal_area_0_random",
        #restore = "/home/PROFACTOR.LOCAL/jthapa/ray_results/static_object/PPOTrainer_WarehouseEnv_3_4c999_00000_0_2022-10-18_14-13-39/checkpoint_008100/checkpoint-8100",
        # resume=True
        # #mode="min",
        stop={
            #"episodes_total": 5000,
        ...
        checkpoint_at_end=True,
        #search_alg=alg,
        #num_samples=50 # number of samples in the hyperparameter search space
    )
