...
CUDA_VISIBLE_DEVICES=1 python train/train_warehouse.py --env_name ${env} \
  --n_block 1 --algorithm_name ${algo} --seed ${seed} \
  --n_training_threads 18 --n_rollout_threads 38  \
  --num_mini_batch 40 --episode_length 120 --num_env_steps 10000000 \
  --lr 0.001 --ppo_epoch 15 --clip_param 0.05 \
  --pair_agents 1 --save_interval 2000000 --num_objects 2 --max_steps 90 \
   --use_eval 
