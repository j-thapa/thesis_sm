...
import torch
from sm.runner.separated.base_runner import Runner
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            if episode % self.log_interval == 0:
                ...
                self.writter.add_scalars("Reward_per_episode", {"reward_per_episode": reward_rate}, total_num_steps)
    ...
    def insert(self, data):
        ...
        for agent_id in range(self.num_agents):
            self.buffer[agent_id].insert(share_obs[:,agent_id], obs[:,agent_id], rnn_states[:,agent_id],
                    ...
                    None, available_actions[:,agent_id])
