...
from sm.utils.separated_buffer import SeparatedReplayBuffer
...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from sm.algorithms.happo_trainer import HAPPO as TrainAlgo
            from sm.algorithms.happo_policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from sm.algorithms.hatrpo_trainer import HATRPO as TrainAlgo
            from sm.algorithms.hatrpo_policy import HATRPO_Policy as Policy
        else:
