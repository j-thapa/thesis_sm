...
echo 'export PATH=/home/PROFACTOR.LOCAL/jthapa/Multi-Agent-Transformer/bin:$PATH' >> ~/.bashrc
echo 'export LD_LIBRARY_PATH=/home/PROFACTOR.LOCAL/jthapa/Multi-Agent-Transformer/lib64:$LD_LIBRARY_PATH' >> ~/.bashrc
source ~/.bashrc
