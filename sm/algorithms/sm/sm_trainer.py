...
from sm.utils.util import get_gard_norm, huber_loss, mse_loss
from sm.utils.valuenorm import ValueNorm
...
class SMTrainer:
    ...
    def ppo_update(self, sample):
        ...
        if self._use_max_grad_norm:
            grad_norm = nn.utils.clip_grad_norm_(self.policy.seq_model.parameters(), self.max_grad_norm)
        else:
            grad_norm = get_gard_norm(self.policy.seq_model.parameters())
